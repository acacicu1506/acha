...
header('Access-Control-Allow-Headers: Content-Type, Access-Control-AllowMethods, Access-Control-Allow-Headers, Authorization, X-Requested-With');
        ...
        switch ($_GET['endpoint']) {
            ...
            case 'film_detail':
                if (isset($_GET['id'])) {
                    ...
                    echo json_encode(['error' => 'Film ID not provided']);
                }
                break;
            default:
