...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['login'])) {
    ...
    $stmt = $koneksi->prepare("SELECT name, password FROM users WHERE email =
?");
...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="../img/cinema.png" />
    <title>W A N CINEMA</title>
                ...
                <div class="col-lg-6">
                    <div class="login__form">
                        ...
                        <form method="POST" action="index.php">
                            ...
                            <button type="submit" name="login" class="btn btn-primary w100 py-8 fs-4 mb-4">Sign
                                In</button>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="footer__logo">
                        <a href="./index.html"><img src="img/lg.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
